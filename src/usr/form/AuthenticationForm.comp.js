...
import { AuthenticationFormTypes } from './AuthenticationForm.props';
...
/**
 * AuthenticationForm is generated by Webcodesk. Replace this comment with a valuable description.
 */
...
AuthenticationForm.propTypes = AuthenticationFormTypes;
...
AuthenticationForm.defaultProps = {
  ...
  onInputTextChange: () => {
    console.info('AuthenticationForm.onInputTextChange is not set');
  },
  onSubmit: () => {
    console.info('AuthenticationForm.onSubmit is not set');
  }
};
