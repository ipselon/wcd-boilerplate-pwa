...
* `BottomNavigation.comp.js` - the source code of the component.
* `BottomNavigation.props.js` - the source code of the PropTypes definitions.
* `BottomNavigation.md` - the source of the current file
