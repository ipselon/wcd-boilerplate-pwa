...
* `PageParametersReceiver.comp.js` - the source code of the component.
* `PageParametersReceiver.props.js` - the source code of the PropTypes definitions.
* `PageParametersReceiver.md` - the source of the current file
