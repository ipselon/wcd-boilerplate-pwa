...
* `GridRepeater.comp.js` - the source code of the component.
* `GridRepeater.props.js` - the source code of the PropTypes definitions.
* `GridRepeater.md` - the source of the current file
