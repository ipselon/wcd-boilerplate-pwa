...
* `ImageHolder.comp.js` - the source code of the component.
* `ImageHolder.props.js` - the source code of the PropTypes definitions.
* `ImageHolder.md` - the source of the current file
